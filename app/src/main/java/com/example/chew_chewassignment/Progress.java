...
public class Progress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView t = new TextView(Progress.this);
        t.setTextSize(15);
        t.setTextColor(Color.BLACK);
        Typeface typeface = ResourcesCompat.getFont(Progress.this, R.font.lato);
    ...
    public void ToCustomerUI(View v){
        Intent reload = new Intent(Progress.this, CustomerUI.class);
