...
public class Pending extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView t = new TextView(Pending.this);
        t.setTextSize(15);
        t.setTextColor(Color.BLACK);
        Typeface typeface = ResourcesCompat.getFont(Pending.this, R.font.lato);
    ...
    public void ToCustomerUI(View v){
        Intent reload = new Intent(Pending.this, CustomerUI.class);
